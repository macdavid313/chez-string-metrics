...
(check (jaro "martha" "marhta") => 0.9444444444444445)
(check (jaro "dwayne" "duane") => 0.8222222222222223)
(check (jaro "dixon" "dicksonx") => 0.7666666666666666)
(check (jaro "jones" "johnson") => (exact->inexact 83/105))
(check (jaro "brain" "brian") => 0.9333333333333332)
(check (jaro "five" "ten") => (exact->inexact 0))
(check (jaro "lucky" "lucky") => (exact->inexact 1))
(check (jaro "" "") => (exact->inexact 1))

;; Jaro-Winkler distance
(check (jaro-winkler "aa" "a") => 0.8500000000000001)
(check (jaro-winkler "a" "aa") => 0.8500000000000001)
(check (jaro-winkler "martha" "marhta") => (exact->inexact 173/180))
(check (jaro-winkler "dwayne" "duane") => 0.8400000000000001)
(check (jaro-winkler "dixon" "dicksonx") => 0.8133333333333332)
(check (jaro-winkler "jones" "johnson") => (exact->inexact 437/525))
(check (jaro-winkler "brain" "brian") => 0.9466666666666665)
(check (jaro-winkler "five" "ten") => (exact->inexact 0))
(check (jaro-winkler "lucky" "lucky") => (exact->inexact 1))
(check (jaro-winkler "" "") => (exact->inexact 1))
